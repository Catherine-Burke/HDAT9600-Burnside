...
ICUMort.f <- ICUMort[,c("Glucose_diff", "WBC_min", "pH_diff", "Bilirubin_min", "BUN_min", "PaO2_max", "RespRate_min", "HR_diff", "Na_max", "GCS_max", "Age", "Gender", "ICUType", "in_hospital_death")]
...
var_selection <- c("Glucose_diff", "WBC_min", "pH_diff", "Bilirubin_min", "BUN_min", "PaO2_max", "RespRate_min", "HR_diff", "Na_max", "GCS_max", "Age", "Gender", "ICUType")
...
full_mod<-glm(in_hospital_death ~ Glucose_diff + WBC_min + pH_diff +
                Albumin_max + BUN_min + RespRate_min + HR_diff + Na_max + GCS_Max +
...
red_mod <- glm(in_hospital_death ~ SOFA + pH_diff + Albumin_max + BUN_min + GCS_Max +
                 RespRate_min + HR_diff + Na_max +Age + Gender + ICUType, 
