...
As shown in the plot of the Schoefeld residuals, the time-varying coefficient for significant variables seems to change at 120. 
Thus, I will choose a follow-up time point around 120 to split the follow-up time to fit two Cox models to attempt to resolve the violation.
