...
###WILL GO BACK AND DO THIS TOMORROW.
...
summary(full_mod)
drop1(full_mod)
#Most variables are significant except gender, Glucose diff, WBC_min
#Remove non-significant variables and compare models - will keep sex in for now.
...
#No significant difference, could accept the simpler model.  However AIC values are still slightly lower when Glucose_diff and WBC_diff are included.
```
